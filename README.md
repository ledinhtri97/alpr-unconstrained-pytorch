...
./run.sh -i samples/vn-test -o output -c output/results.csv -l wpod_cvt.pth

./run.sh -i samples/vn-test -o output -c output/results.csv -l trained_models/WPOD_epoch_160_loss_7.8601.pth

./run.sh -i samples/vn-test -o output -c output/results.csv -l  models/my-trained-model/my-trained-model_backup.h5
