...
#     print('-'*50)
#     print(angles, whratio, wsiz, dx, dy)
#     print('-'*50)
#     exit()
#     angles = np.array([0.17548758, 0.1465065, 0.03839053])
#     whratio = 3.00721952848222
#     wsiz = 158.43077363405536 
#     hsiz = wsiz/whratio
#     dx = 44.39045487912034
#     dy = 145.4581649050818
